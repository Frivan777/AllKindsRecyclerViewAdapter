...
private val ICONS = arrayOf(
        ...
        R.drawable.contact5, R.drawable.contact6, R.drawable.contact7, R.drawable.contact8, R.drawable.contact9,
        R.drawable.contact10, R.drawable.contact11, R.drawable.contact12, R.drawable.contact13, R.drawable.contact14,
        R.drawable.contact15, R.drawable.contact16, R.drawable.contact17, R.drawable.contact18
)

private val NAMES = arrayOf(
        "Agatha MacDonald", "Albert O’Connor", "Adam Gordon", "Amanda Brian", "Alexander Chester",
        "Andrew Grant", "Anna Ross", "Augusta Walter", "Audrey Smith", "Allan Butler", "Alison Black",
        "Barrett Nash-Williams", "Bruce Robertson", "Boris Jones", "Carl Murphy", "Carla Williams", "Catherine Edwards",
        "Cliff Birds"
)
        ...
        val adapter = ContactAdapter {
            if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
                    val options = ActivityOptions.makeSceneTransitionAnimation(this,
                            it.third, activity.getString(R.string.email_auth_transition))
                    bundle = options.toBundle()
            } else {
                this.startActivity(DetailContactActivity.newIntent())
            }
        }.apply {
            submitList(items)
        }
